...
### The below command will delete the pod after 30 seconds if operations is successful

    kubectl delete pod mybox

### The below command will delete the pod immediately

    kubectl delete pod mybox --wait=false

### Kill the pod brutally
