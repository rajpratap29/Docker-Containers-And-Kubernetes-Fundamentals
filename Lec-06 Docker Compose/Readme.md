# Lec-06 Docker Compose
- Define and run multi-containers applications with a single command
...
When the app will run, launch the voting app in your browser http://localhost:5001
...
This fails because the localhost port 5001 is already assigned.
